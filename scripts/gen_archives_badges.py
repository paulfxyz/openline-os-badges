"""Generate Archives section-tab badges in the section-badge family."""
import sys, os
...
NEW = [
    # filename, color, icon, label  (colors echo the category select colors)
    ("badge-arch-files.png",     PAL["orange"], "files",          "Files"),
    ("badge-arch-os-hubs.png",   PAL["blue"],   "boxes",          "OS Hubs"),
    ("badge-arch-resources.png", PAL["violet"], "folder-archive", "Resources"),
    ("badge-arch-other.png",     PAL["slate"],  "archive",        "Other"),
]
